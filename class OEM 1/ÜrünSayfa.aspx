<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ÜrünSayfa.aspx.cs" Inherits="class_OEM_1.ÜrünSayfa" %>
            ...
            <tr>
                ...
                <td class="auto-style4">
                    <div class="menuler">
                        ...
                        <asp:TextBox ID="Minimum" runat="server" CssClass="filtred" Width="50px" TextMode="Number"></asp:TextBox>
                        <asp:TextBox ID="Maksimum" runat="server" CssClass="filtred" Width="50px" TextMode="Number"></asp:TextBox>
                        <hr class="auto-style5" style="border-width: 0px; background-color: #000000; border-color: #000000; width: 100%; height: 2px;" />
                        <asp:Button ID="filtreuygula" CssClass="menuelements" runat="server" Text="UYGULA" />
                    </div>
                </td>
